...
cd ~; wget -q https://www.python.org/ftp/python/3.5.2/Python-3.5.2.tgz; wget -q https://repo.continuum.io/miniconda/Miniconda3-4.2.11-Linux-x86_64.sh

# install Python3.5.2 & Anaconda3-4.2.0
cd ~; tar -xzf Python-3.5.2.tgz; cd Python-3.5.2; ./configure; make; make install
cd ~; bash Miniconda3-4.2.0-Linux-x86_64.sh -b
